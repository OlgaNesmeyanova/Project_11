...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Api */ \"./JS/Api.js\");\n/* harmony import */ var _Card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Card */ \"./JS/Card.js\");\n/* harmony import */ var _CardList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CardList */ \"./JS/CardList.js\");\n/* harmony import */ var _FormValidator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./FormValidator */ \"./JS/FormValidator.js\");\n/* harmony import */ var _Popup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Popup */ \"./JS/Popup.js\");\n/* harmony import */ var _UserInfo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./UserInfo */ \"./JS/UserInfo.js\");\n/* harmony import */ var _pages_index_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../pages/index.css */ \"./pages/index.css\");\n/* harmony import */ var _pages_index_css__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_pages_index_css__WEBPACK_IMPORTED_MODULE_6__);\n\n\n\n\n\n\n\n\n(function () {\n  var placesList = document.querySelector('.places-list');\n  var popupElementPlace = document.querySelector('.popup_new-place');\n  var popupNewPlace = new _Popup__WEBPACK_IMPORTED_MODULE_4__[\"default\"](popupElementPlace);\n  var addNewPlaceButton = document.querySelector('.user-info__button_new-place');\n  var newPlaceForm = popupElementPlace.querySelector('.popup__form');\n  var closeNewPlaceButton = popupElementPlace.querySelector('.popup__close');\n  var popupElement = document.querySelector('.popup_profile');\n  var popupProfile = new _Popup__WEBPACK_IMPORTED_MODULE_4__[\"default\"](popupElement);\n  var editButton = document.querySelector('.user-info__button_edit');\n  var profileForm = popupElement.querySelector('.popup__form');\n  var closeProfileButton = popupElement.querySelector('.popup__close');\n  var largePictureElement = document.querySelector('.popup_large-picture');\n  var largePicture = new _Popup__WEBPACK_IMPORTED_MODULE_4__[\"default\"](largePictureElement);\n  var closeLargePictureButton = largePictureElement.querySelector('.popup__close');\n  var profileValidator = new _FormValidator__WEBPACK_IMPORTED_MODULE_3__[\"default\"](profileForm);\n  var newPlaceValidator = new _FormValidator__WEBPACK_IMPORTED_MODULE_3__[\"default\"](newPlaceForm);\n  var api = new _Api__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n  var userName = document.querySelector('.user-info__name');\n  var job = document.querySelector('.user-info__job');\n  var avatar = document.querySelector('.user-info__photo');\n  var userInfoBlock = new _UserInfo__WEBPACK_IMPORTED_MODULE_5__[\"default\"](userName, job, avatar);\n  api.getUserData().then(function (res) {\n    userInfoBlock.setUserInfo(res.name, res.about, res.avatar);\n    userInfoBlock.updateUserInfo();\n  }).catch(function (err) {\n    console.log(err);\n  });\n  editButton.addEventListener('click', function () {\n    profileForm.elements.name.value = userName.textContent;\n    profileForm.elements.about.value = job.textContent;\n    popupProfile.open();\n    profileValidator.setEventListeners();\n  });\n\n  function editProfile(event) {\n    event.preventDefault();\n    api.editProfile(profileForm.elements.name.value, profileForm.elements.about.value).then(function () {\n      userInfoBlock.setUserInfo(profileForm.elements.name.value, profileForm.elements.about.value, avatar);\n      userInfoBlock.updateUserInfo();\n      popupProfile.close();\n      profileValidator.removeEventListener();\n      profileForm.reset();\n    }).catch(function (err) {\n      console.log(err);\n    });\n  }\n\n  profileForm.addEventListener('submit', editProfile);\n  closeProfileButton.addEventListener('click', function () {\n    popupProfile.close();\n    profileValidator.resetErrors();\n    profileValidator.removeEventListener();\n  });\n  var cardList = new _CardList__WEBPACK_IMPORTED_MODULE_2__[\"default\"](placesList);\n  api.getInitialCards().then(function (res) {\n    var initialCards = res.map(function (item) {\n      return new _Card__WEBPACK_IMPORTED_MODULE_1__[\"default\"](item.name, item.link, largePicture).create();\n    });\n    cardList.render(initialCards);\n  }).catch(function (err) {\n    console.log(err);\n  });\n\n  function addNewCard(event) {\n    event.preventDefault();\n    var name = newPlaceForm.elements.name;\n    var link = newPlaceForm.elements.link;\n    var newPlaceCard = new _Card__WEBPACK_IMPORTED_MODULE_1__[\"default\"](name.value, link.value, largePicture);\n    var newPlaceCardElement = newPlaceCard.create();\n    api.addNewCard(name.value, link.value).then(function () {\n      cardList.addCard(newPlaceCardElement);\n      popupNewPlace.close();\n      newPlaceValidator.removeEventListener();\n      newPlaceForm.reset();\n    }).catch(function (err) {\n      console.log(err);\n    });\n  }\n\n  newPlaceForm.addEventListener('submit', addNewCard);\n  addNewPlaceButton.addEventListener('click', function () {\n    popupNewPlace.open();\n    newPlaceValidator.setEventListeners();\n  });\n  closeNewPlaceButton.addEventListener('click', function () {\n    popupNewPlace.close();\n    newPlaceValidator.resetErrors();\n    newPlaceValidator.removeEventListener();\n    newPlaceForm.reset();\n  });\n  closeLargePictureButton.addEventListener('click', function () {\n    return largePicture.close();\n  });\n})();\n\n//# sourceURL=webpack:///./JS/index.js?");
